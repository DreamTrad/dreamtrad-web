...
Comme j’ai pu le dire plus haut, après 7 projets, nous commençons à être bien rodés, donc l’organisation et la mise en place d’un projet, tout cela est devenu très fluide de notre côté. Nous avons également plusieurs outils pour aider à la traduction, et notamment à la correction. Bref, on est suffisamment aguerri pour porter divers projets de traduction.
...
Le détail de comment se passe un projet est décrit dans [cet autre article](/articles/0002-fonctionnement_projet).
