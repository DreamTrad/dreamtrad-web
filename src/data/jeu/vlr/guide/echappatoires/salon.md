---
Solution de l’échappatoire du salon dans Virtue’s Last Reward.
---
# Échappatoire salon

:::spoiler[la position des objets et éléments importants]
![Image interaction 1](/assets/jeu/vlr/guide/echappatoires/salon/interaction_1.webp)

![Image interaction 2](/assets/jeu/vlr/guide/echappatoires/salon/interaction_2.webp)

![Image interaction 3](/assets/jeu/vlr/guide/echappatoires/salon/interaction_3.webp)
...
- Le demi-hémisphère sud dans le placard de droite sous le coffre.
- Le demi-hémisphère nord par terre devant le canapé.
- Le magazine d’astronomie derrière le coussin de gauche du canapé.

## Résolution des énigmes

Mettez les 2 aiguilles sur l’horloge en forme de soleil au-dessus du canapé. Il faut ensuite les régler sur une heure précise. Aidez-vous du magazine d’astronomie.

:::spoiler[comment orienter les aiguilles]
...
:::spoiler[la solution]
RED MOON, BLUE PLANET, GREEN SUN
:::

L’écran s’allume vous montrant le code pour le coffre, ouvrez-le et récupérez le contenu.

Vous pouvez sortir de la salle pour terminer l’échappatoire.

## Obtenir le 2nd mot de passe du coffre

Il faut faire d’autres cocktails. Il faut se servir du journal du barman pour trouver les cocktails et l’ordre.

Une des trois personnes ment. Pour savoir quels cocktails préparer, il faut trouver le menteur pour ne pas prendre en compte sa remarque.

:::spoiler[qui ment et quels cocktails préparer]
C’est le fils qui ment.
- Père : WHITE ISLAND
- Mère : RED PLANET
- Fils : BLUE OCEAN
:::

Ensuite pour l’ordre dans lequel les poser, il faut reprendre les places où se sont assises chaque personne, sans oublier que le journal décrit le point de vue du barman.

:::spoiler[l’ordre dans lequel placer les cocktails]
L’ordre ne notre point de vue à nous : BLUE OCEAN, WHITE ISLAND, RED PLANET
:::